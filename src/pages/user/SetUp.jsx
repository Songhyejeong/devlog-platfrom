            ...
            <SetUpBox>
                <SetUpUserBox>
                    ...
                    <UserInfo darkMode={darkMode}>
                        ...
                        <InputProfileBox darkMode={darkMode} visible={isProfileInput}>
                            <input type="text" placeholder="hae_oo" />
                            <input type="text" placeholder="한줄 소개 입니다." />
                            <div>
                                <button
                                    onClick={() => {
                                        setIsProfileInput(!isProfileInput);
                ...
                <SetUpContentBox>
                    ...
                    <SetupCardBox darkMode={darkMode}>
                        ...
                        <SetUpDescription>
                            <p>탈퇴시 작성하신 포스트 및 댓글이 삭제되며 복구되지 않습니다.</p>
                        </SetUpDescription>
                    </SetupCardBox>
                </SetUpContentBox>
            </SetUpBox>
...
const UserInfo = styled.div`
    ...
    @media (max-width: 770px) {
        ...
        border-bottom: solid 1px ${(props) => (props.darkMode ? '#252525' : '#e9ecef')};
    }
`;
